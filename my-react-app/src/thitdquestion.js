            ...
            <div className="container ">
                <div className="row">
                    ...
                    <div className="col-12 col-md-8 card">
                        ...
                        <p>Note: <b>Multipule Question with parital Marketing</b> Will have a minimum of 3 options and a maximum of 5 options.<br />
                        ...
                        <p className="my-2"><b>Correct Answer *</b></p>
                        <p><b>Note: Select the correct option for this question and the respective partial perecentage for each Option</b></p>
                        <div className="d-flex flex-row ">
                        <div>
                            <input type="checkbox" />
                        </div>
