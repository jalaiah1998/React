...
const Designation1 = () => {
    ...
    const fetchblogs = async () => {
        ...
        const authToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NGVlZTIxOGIxNGEzNTJlMjQyM2JiYzYiLCJpYXQiOjE2OTMzNzcwNjl9.DBa4x-pEsO5fVkC8Dh7-c1oYuVhboy1QIuDUAs5iKkE"
        try {
                        ...
                        {bloglist.map((blog) => (
                            <div key={blog._id}>
                                ...
                                <div className="col-12 row" style={{ border: "1px solid black" }}>
                                    ...
                                    <img src="https://media.licdn.com/dms/image/C560BAQEAOMY1IT0VIg/company-logo_200_200/0/1614081825631?e=2147483647&v=beta&t=o7kSEmSfcdH_gkLD0kAsGxX1fnZ2Fj9z8Skybb3na78 " width={150}></img>
                                    ...
                                    <p className="text-center">1st floor, vertex corporate Bldg, jubilee Enclave,Hitex Madhapur,Hyderabad-58001.p:(040)29800028</p>
                                    <h2 className="text-center">Pay slip for the month of july 2023</h2>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-md-6 card" style={{ border: "1px solid black" }} >
